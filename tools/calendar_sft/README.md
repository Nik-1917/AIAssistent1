...
[`docs/calendar_sft_data_provenance_v1.json`](../../docs/calendar_sft_data_provenance_v1.json).
...
build\calendar_sft_local_gpu_venv\Scripts\python.exe tools\calendar_sft\train_qlora.py `
  ...
  --train-file build\calendar_sft_dataset\train.jsonl `
  --validation-file build\calendar_sft_dataset\validation.jsonl `
  --dataset-provenance docs\calendar_sft_data_provenance_v1.json `
...
python tools/calendar_sft/verify_dataset_provenance.py `
  --register docs\calendar_sft_data_provenance_v1.json `
  --train-file build\calendar_sft_dataset\train.jsonl `
  --validation-file build\calendar_sft_dataset\validation.jsonl
```

2. Run `train_qlora.py --dataset-provenance docs\calendar_sft_data_provenance_v1.json`
