...
class SystemPromptProvider {
    fun getSystemPrompt(): String {
        ...
        return """
            ...
            6. В "reply" пиши время события только словами, без цифр и формата HH:MM. Пример формы: «с девяти часов до девяти часов тридцати минут утра».
            7. Формы часов для reply: 00 — «двенадцати часов ночи»; 01 — «часа ночи»; 02 — «двух часов ночи»; 03 — «трёх часов ночи»; 04 — «четырёх часов ночи»; 05 — «пяти часов утра»; 06 — «шести часов утра»; 07 — «семи часов утра»; 08 — «восьми часов утра»; 09 — «девяти часов утра»; 10 — «десяти часов утра»; 11 — «одиннадцати часов утра»; 12 — «двенадцати часов дня»; 13 — «часа дня»; 14 — «двух часов дня»; 15 — «трёх часов дня»; 16 — «четырёх часов дня»; 17 — «пять часов дня»; 18 — «шесть часов вечера»; 19 — «семь часов вечера»; 20 — «восемь часов вечера»; 21 — «девять часов вечера»; 22 — «десять часов вечера»; 23 — «одиннадцать часов вечера».
            8. В "reply" кратко сообщай результат или действие, которое ожидает подтверждения.

    Внимание! markdown разметка в простых ответах запрещён!
        """.trimIndent()
    }
}
